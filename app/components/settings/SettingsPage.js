                ...
                <div className="flex flex-col lg:flex-row gap-8 items-start w-full">
                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <SettingsInput label="Name:" name="name" value={form.name} onChange={handleChange} />
                            <SettingsInput label="Job:" name="job" value={form.job} onChange={handleChange} />
                        </div>
                        <SettingsTextarea label="About Me:" name="about" value={form.about} onChange={handleChange} />
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <SettingsInput label="Strength:" name="stregth" value={form.stregth} onChange={handleChange} />
                            <SettingsInput label="Weakness:" name="weakness" value={form.weakness} onChange={handleChange} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <SettingsInput label="Master Objective:" name="masterObjective" value={form.masterObjective} onChange={handleChange} />
                            <SettingsInput label="Minor Objective:" name="minorObjective" value={form.minorObjective} onChange={handleChange} />
                        </div>
                        <button
                            type="submit"
